...
const Home = () => {
  ...
  if (deposits.length === 0) {
    return (
      <div
        className={"flex flex-col gap-12 justify-center items-center h-[90vh]"}
      >
        <img
          src={"/img/urban-683.png"}
          className={"opacity-90 w-[400px] -mb-12"}
          alt="logo"
        />
  ...
  return (
    <div className={"flex justify-center"}>
      <div
        className={
          "flex flex-col gap-12 justify-center items-center w-[780px] list-wrappergit pt-12 pb-16"
        }
      >
